...
Imgbody = pygame.transform.scale(pygame.image.load('vitcon.jpg'),(m,m))
Imghead = pygame.transform.scale(pygame.image.load('vitme.jfif'),(m,m))
Imgfood = pygame.transform.scale(pygame.image.load('thucanvit.png'),(m,m))
# tạo cửa sổ
